...
public class GlobalCommands
{
    ...
    public void Init()
    {
        ...
        CreateAction("Atom", "Disable_Collisions", () => OnSelectedAtom(atom => atom.collisionEnabled = false));
        ...
        CreateAction("Add", "Shapes_ISCube", () => SuperController.singleton.AddAtomByType("ISCube", true, true, true));
        CreateAction("Add", "Shapes_ISSphere", () => SuperController.singleton.AddAtomByType("ISSphere", true, true, true));
        CreateAction("Add", "Shapes_ISCapsule", () => SuperController.singleton.AddAtomByType("ISCapsule", true, true, true));
        CreateAction("Add", "Shapes_ISCone", () => SuperController.singleton.AddAtomByType("ISCone", true, true, true));
        CreateAction("Add", "Shapes_ISCylinder", () => SuperController.singleton.AddAtomByType("ISCylinder", true, true, true));
        CreateAction("Add", "Shapes_ISTube", () => SuperController.singleton.AddAtomByType("ISTube", true, true, true));
        CreateAction("Add", "Sound_AptSpeaker", () => SuperController.singleton.AddAtomByType("AptSpeaker", true, true, true));
        CreateAction("Add", "Sound_AudioSource", () => SuperController.singleton.AddAtomByType("AudioSource", true, true, true));
        CreateAction("Add", "Sound_RhythmAudioSource", () => SuperController.singleton.AddAtomByType("RhythmAudioSource", true, true, true));
        CreateAction("Add", "Toys_Dildo", () => SuperController.singleton.AddAtomByType("Dildo", true, true, true));
        CreateAction("Add", "Toys_Paddle", () => SuperController.singleton.AddAtomByType("Paddle", true, true, true));
        CreateAction("Add", "Triggers_Button", () => SuperController.singleton.AddAtomByType("Button", true, true, true));
        ...
        CreateAction("Add", "Triggers_UIButtonImage", () => SuperController.singleton.AddAtomByType("UIButtonImage", true, true, true));
